  ...
  return (
    <main className="container-xl prose mx-20 py-2">
      <div>
        ...
        <ul>
          <li>
            <a href="https://github.com/heroku-reference-apps">Heroku Reference Applications</a>
          </li>
          <li>
            <a href="https://github.com/heroku-reference-apps/menumaker">Menu Maker - ChatGPT Function Calling</a>
          </li>
          <li>
            <a href="https://github.com/heroku-reference-apps/employee-directory-gpt-action">Employee Directory - Custom GPT Action</a>
          </li>
          <li>
          ...
          <li>
            <a href="https://developer.salesforce.com/blogs/2023/11/building-ai-applications-with-langchain-and-node-js">Building AI Applications with LangChain and Node.js</a>
          </li>
          <li>
